...
import {
  ...
  GetEmpresaPort,
} from '../../../../domain/ports/in/get-empresa.port';
import {
  UPDATE_EMPRESA_USE_CASE,
  UpdateEmpresaPort,
} from '../../../../domain/ports/in/update-empresa.port';
...
export class EmpresaController {
  ...
  @Put()
  @Roles('ADMINISTRACION_PRINCIPAL', 'ADMINISTRADOR', 'ADMINISTRACION')
