...
import {
  ITypeCreditNoteCommandPort,
  ITypeCreditNoteQueryPort,
} from '../../../../domain/ports/in/type-credit-note-port-in';
...
export class TypeCreditRestController {
  ...
  @Roles('ADMINISTRADOR', 'ADMINISTRACION') // Usualmente tipos/catálogos son de admin
  async registerTypeCreditNote(
    @Body() registerDto: RegisterTypeCreditNoteDto,
  ): Promise<TypeCreditResponseDto> {
    const newTypeCreditNote =
      await this.typeCreditNoteCommandService.registerTypeCreditNote(
        registerDto,
      );
  ...
  async updateTypeCreditNote(
    ...
    const updatedTypeCreditNote =
      await this.typeCreditNoteCommandService.updateTypeCreditNote(
        fullUpdateDto,
      );
  ...
  async deleteTypeCreditNote(
    ...
    const deletedTypeCreditNote =
      await this.typeCreditNoteCommandService.deleteTypeCreditNote(id);
  ...
  @HttpCode(HttpStatus.OK)
  @Roles('ADMINISTRADOR', 'ADMINISTRACION')
  async listTypeCreditNotes(
    @Query() filters: TypeCreditNoteFilterDto,
  ): Promise<TypeCreditNoteListResponse> {
  ...
  @Get(':id')
  @Roles('ADMINISTRADOR', 'ADMINISTRACION')
  async getTypeCreditNoteById(
    @Param('id', ParseIntPipe) id: number,
  ): Promise<TypeCreditResponseDto> {
    const updatedTypeCreditNote =
      await this.typeCreditNoteQueryService.getTypeCreditNoteById(id);
